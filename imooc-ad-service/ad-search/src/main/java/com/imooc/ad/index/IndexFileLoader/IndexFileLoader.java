package com.imooc.ad.index.IndexFileLoader;
...
@Component
@DependsOn("dataTable") //依赖
public class IndexFileLoader {

    /** 注解含义spring容器加载IndexFileLoader的时候就可以运行init();方法
    全量索引就会加载到系统里 */
    @PostConstruct
    public void init(){
        //2
        ...
        adCreativeStrings.forEach(cu -> AdLevelDataHandler.handleLevel3(
